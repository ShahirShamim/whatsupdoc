...
<body>
<?php $d_id = $_GET['Key']; ?>
<form name="Book Appointment2" method="post" action="edit_appointmentadmin2.php?Key=<?php echo $d_id ?>" style="border: 1px solid #ccc;">
  <h1>Edit Appointment</h1>
  <p>Select new time slot: </p>
  Time:
  <?php session_start(); $hospital_id = $_SESSION['varhospital']; ?>
  <?php $slot_date = $_POST['date']; ?>
  <?php $s_id = $_POST['slot']; ?>
  <?php $p_id = $_POST['patient']; ?>
  ...
  <input type="hidden" name="patient" value="<?php echo $p_id; ?>" />
