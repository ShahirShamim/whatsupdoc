...
<body>
<?php session_start(); $d_id = $_SESSION['varid']; ?>
<form name="Book Appointment2" method="post" action="edit_docappointment.php?Key=<?php echo $d_id ?>" style="border: 1px solid #ccc;">
